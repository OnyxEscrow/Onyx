/**
 * NEXUS SDK Error Classes
 */

import type { NexusErrorCode, ApiErrorResponse } from './types.js';

/**
 * Base error class for all NEXUS API errors
 */
export class NexusApiError extends Error {
  ...
  constructor(
    ...
    if (Error.captureStackTrace) {
      Error.captureStackTrace(this, NexusApiError);
    }
  }
   ...
   */
  static fromResponse(response: ApiErrorResponse, statusCode: number): NexusApiError {
    return new NexusApiError(
      response.error.message,
      response.error.code as NexusErrorCode,
      statusCode,
   ...
   */
  isCode(code: NexusErrorCode): boolean {
 ...
 */
export class AuthorizationError extends NexusApiError {
  constructor(message: string, requestId?: string) {
 ...
 */
export class ValidationError extends NexusApiError {
 ...
 */
export class InvalidAddressError extends NexusApiError {
  /** The invalid address */
 ...
 */
export class EscrowError extends NexusApiError {
  /** The escrow ID */
