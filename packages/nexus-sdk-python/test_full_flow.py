#!/usr/bin/env python3
"""Full escrow flow test via NEXUS Python SDK.
...
async def main() -> None:
    ...
    print("\n\033[1m╔══════════════════════════════════════════════════════════╗\033[0m")
    print("\033[1m║    NEXUS SDK — Full Escrow Flow Test                     ║\033[0m")
    print("\033[1m╚══════════════════════════════════════════════════════════╝\033[0m")

    async with NexusClient(api_key=API_KEY, base_url=BASE_URL) as client:
