...
A Python client library for the NEXUS Escrow-as-a-Service API.
...
For more information, see https://docs.nexus.io/sdk/python
"""
...
async def create_escrow(
    ...
    **kwargs: object,
    ...
    For multiple operations, use NexusClient as a context manager instead.
    ...
    """
    async with NexusClient(api_key=api_key) as client:
