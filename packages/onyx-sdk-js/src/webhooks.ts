 ...
 * @example
 * ```typescript
 * import { verifyWebhookSignature } from '@onyx-escrow/sdk';
 *
 * app.post('/webhooks/onyx', async (req, res) => {
 *   const signature = req.headers['x-onyx-signature'];
 *   const timestamp = req.headers['x-onyx-timestamp'];
 *
