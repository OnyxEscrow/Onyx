//! # onyx-crypto-wasm
//!
//! WASM bindings for onyx-crypto-core, enabling browser-based Monero multisig.
//!
...
pub fn frost_dkg_part2(
    ...
    use onyx_crypto_core::frost::dkg_part2;
    use serde::Serialize;
...
pub fn decrypt_data(
    ...
    use onyx_crypto_core::encryption::decrypt_data as decrypt;
...
pub fn backup_encrypted_size(plaintext_len: usize) -> usize {
    onyx_crypto_core::encryption::backup::encrypted_size(plaintext_len)
}
