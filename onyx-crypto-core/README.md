...
[![Crates.io](https://img.shields.io/crates/v/onyx-crypto-core.svg)](https://crates.io/crates/onyx-crypto-core)
[![Documentation](https://docs.rs/onyx-crypto-core/badge.svg)](https://docs.rs/onyx-crypto-core)
...
```toml
[dependencies]
onyx-crypto-core = "0.1"
```

### Generate FROST Key Shares (2-of-3 Multisig)

```rust
use onyx_crypto_core::{dkg_part1, dkg_part2, dkg_part3, extract_secret_share};
...
```rust
use onyx_crypto_core::{compute_partial_key_image, aggregate_partial_key_images};
...
```rust
use onyx_crypto_core::keys::{validate_address_for_network, MoneroNetwork};
...
- [Onyx Escrow](https://github.com/onyx-escrow/onyx) — Full escrow platform
